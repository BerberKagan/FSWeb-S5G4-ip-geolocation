...
function getApiDetails() {
  ...
  _axios.default.get("https://apis.ergineer.com/ipgeoapi/176.33.67.173").then(function (response) {
...
var kartYapici = function kartYapici(data) {
  var kart = document.createElement('div');
  kart.classList.add('card');
  var foto = document.createElement('img');
  foto.setAttribute('src', data === null || data === void 0 ? void 0 : data.ülkebayrağı);
  kart.append(foto);
  var kartBilgileri = document.createElement('div');
  kartBilgileri.classList.add('card-info');
  kart.append(kartBilgileri);
  var ipBilgisi = document.createElement('h3');
  ipBilgisi.classList.add('ip');
  kartBilgileri.append(ipBilgisi);
  ipBilgisi.textContent = "IP: ".concat(data === null || data === void 0 ? void 0 : data.sorgu);
  var ulkeBilgisi = document.createElement('p');
  ulkeBilgisi.classList.add('ulke');
  kartBilgileri.append(ulkeBilgisi);
  ulkeBilgisi.textContent = "".concat(data === null || data === void 0 ? void 0 : data.ülke, " (").concat(data === null || data === void 0 ? void 0 : data.ülkeKodu, ")");
  var enlemBilgisi = document.createElement('p');
  kartBilgileri.append(enlemBilgisi);
  enlemBilgisi.textContent = "Enlem: ".concat(data === null || data === void 0 ? void 0 : data.enlem, " Boylam: ").concat(data === null || data === void 0 ? void 0 : data.boylam);
  var sehirBilgisi = document.createElement('p');
  kartBilgileri.append(sehirBilgisi);
  sehirBilgisi.textContent = "\u015Eehir: ".concat(data === null || data === void 0 ? void 0 : data.şehir);
  var saatBilgisi = document.createElement('p');
  kartBilgileri.append(saatBilgisi);
  saatBilgisi.textContent = "Saat Dilimi: ".concat(data === null || data === void 0 ? void 0 : data.saatdilimi);
  var paraBilgisi = document.createElement('p');
  kartBilgileri.append(paraBilgisi);
  paraBilgisi.textContent = "Para Birimi: ".concat(data === null || data === void 0 ? void 0 : data.parabirimi);
